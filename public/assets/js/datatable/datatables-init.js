        ...
        init: function () {
            ...
            var oTable = $('#simpledatatable').dataTable({
                ...
                "oTableTools": {
                    ...
                    "sSwfPath": "/Public/js/swf/copy_csv_xls_pdf.swf"
                },
                "language": {
                    "search": "",
                    "sLengthMenu": "_MENU_",
    ...
    return {
        init: function () {
            ...
            function fnFormatDetails(oTable, nTr) {
                ...
                var sOut = '<table>';
                sOut += '<tr><td rowspan="5" style="padding:0 10px 0 0;"><img src="/Public/img/avatars/' + aData[6] + '"/></td><td>Name:</td><td>' + aData[1] + '</td></tr>';
