...
<head>
    ...
    <title>Hwi后台管理系统 - 主页</title>

    <meta name="keywords" content="Hwi后台管理系统,后台bootstrap框架,会员中心主题,后台HTML,响应式后台">
    ...
    <link href="{{asset('hwiadmin/css/bootstrap.min14ed.css?v=3.3.6') }} " rel="stylesheet">
    <link href="{{asset('hwiadmin/css/font-awesome.min93e3.css?v=4.4.0') }} " rel="stylesheet">
    <link href="{{asset('hwiadmin/css/animate.min.css') }} " rel="stylesheet">
    <link href="{{asset('hwiadmin/css/style.min862f.css?v=4.1.0') }}" rel="stylesheet">
</head>
...
<body class="fixed-sidebar full-height-layout gray-bg" style="overflow:hidden">
    <div id="wrapper">
                ...
                <ul class="nav" id="side-menu">
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            ...
                            <li>
                                <a class="J_menuItem" href="admin/OperationLog">操作记录</a>
                            </li>
                        </ul>
        ...
        <div id="page-wrapper" class="gray-bg dashbard-1">
            ...
            <div class="row J_mainContent" id="content-main">
                <iframe class="J_iframe" name="iframe0" width="100%" height="100%" src="admin/SysInfo" frameborder="0" data-id="SysInfo" seamless></iframe>
            </div>
            <div class="footer">
                <div class="pull-right">&copy; 2017-2020 <a href="#" target="_blank">Bboy Hwi blog</a>
                </div>
            </div>
        </div>
        <!--右侧部分结束-->
    ...
    <script src="{{asset('hwiadmin/js/jquery.min.js?v=2.1.4')}} "></script>
    <script src="{{asset('hwiadmin/js/bootstrap.min.js?v=3.3.6')}} "></script>
    <script src="{{asset('hwiadmin/js/plugins/metisMenu/jquery.metisMenu.js')}} "></script>
    <script src="{{asset('hwiadmin/js/plugins/slimscroll/jquery.slimscroll.min.js')}} "></script>
    <script src="{{asset('hwiadmin/js/plugins/layer/layer.min.js')}}"></script>
    <script src="{{asset('hwiadmin/js/hplus.min.js?v=4.1.0')}}"></script>
    <script type="text/javascript" src="{{asset('hwiadmin/js/contabs.min.js')}}"></script>
    <script src="{{asset('hwiadmin/js/plugins/pace/pace.min.js')}}"></script>
</body>
</html>
